...
import com.example.beritaku.api.ApiService;
import com.example.beritaku.api.Server;
import com.example.beritaku.models.News;
import com.example.beritaku.models.ResponseNews;
import com.example.beritaku.utils.NewsAdapter;
            ...
            api.getListSearch(keyword, "id", category, "publishedAt", key).enqueue(new Callback<ResponseNews>() {
                ...
                public void onResponse(Call<ResponseNews> call, Response<ResponseNews> response) {
                    if (response.isSuccessful()) {
                        ...
                        hideDialog();
                        Toast.makeText(EntertainmentActivity.this, "Gagal mengambil data !", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(Call<ResponseNews> call, Throwable t) {
                    hideDialog();
                    Toast.makeText(EntertainmentActivity.this, "Gagal menyambung ke internet !", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
